...
/**
 * https://blog.csdn.net/zhangqunshuai/article/details/80733982
 */
...
//        canvas.drawCircle(mXCenter, mYCenter, mRadius + mStrokeWidth, mBigPatient);
        ...
        if (mProgress > 0) {
            ...
            Timber.i(oval.left + "   " + oval.top + "     " + oval.right + "   " + oval.bottom);
            ...
            Timber.i("0c    mProgress   " + mProgress + "   mTotalProgress    " + mTotalProgress + "   (mProgress / mTotalProgress) * 360 " + ((float) mProgress / mTotalProgress) * 360);
        }
    }
